          ...
          {pillars.map((pillar, index) => (
            ...
            >
              ...
              <div className="space-y-10 relative z-10">
                ...
                <Link href="/vision" className="flex items-center gap-4 text-[10px] font-black text-white uppercase tracking-[0.4em] group-hover:gap-6 transition-all duration-500 cursor-pointer w-fit group/btn">
